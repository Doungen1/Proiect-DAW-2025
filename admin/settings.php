        ...
        <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="form-check form-switch">
                                <!-- Elimină formularul suplimentar dacă nu este necesar -->
                                <input onchange="upd_shutdown(this.checked ? 1 : 0)" class="form-check-input" type="checkbox" id="shutdown-toggle">
                            </div>
                        </div>
                        <p class="card-text">
                            No customers will be allowed to book hotel, when shutdown mode is enabled.
                        </p>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4"><h6 class="card-subtitle mb-1 fw-bold">Address</h6>
                                <p class="card-text" id="address"></p>
                            </div>
                            <div class="mb-4"><h6 class="card-subtitle mb-1 fw-bold">Google Map</h6>
                                <p class="card-text" id="gmap"></p>
                            </div>
                            <div class="mb-4"><h6 class="card-subtitle mb-1 fw-bold">Phone Numbers</h6>
                            ...
                            <div class="mb-4"><h6 class="card-subtitle mb-1 fw-bold">E-mail</h6>
                                <p class="card-text" id="email"></p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-4"><h6 class="card-subtitle mb-1 fw-bold">Social Links</h6>
                                <p class="card-text mb-1">
                            ...
                            <div class="mb-4"><h6 class="card-subtitle mb-1 fw-bold">iFrame</h6>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="fb" id="fb" class="form-control shadow-none" required>
                                                    </div>
                                                    <div class="input-group mb-3">
            ...
            <!-- <?php echo $_SERVER['DOCUMENT_ROOT']; ?> --> <!-- Path to root folder -->
